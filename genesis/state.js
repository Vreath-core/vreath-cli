...
exports.genesis_state = [vr.state.create_state("00", vr.con.constant.unit, genesis_unit_address, one_amount, ["01", "00"])];
exports.genesis_token = [vr.state.create_token("00", vr.con.constant.native), vr.state.create_token("00", vr.con.constant.unit, one_amount)];
