...
exports["default"] = router.post('/tx', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_g) {
        switch (_g.label) {
            ...
            case 2:
                pool = _b.apply(_a, [_g.sent()]);
                _d = (_c = JSON).parse;
                return [4 /*yield*/, util_1.promisify(fs.readFile)('./json/chain.json', 'utf-8')];
            case 3:
                chain = _d.apply(_c, [_g.sent()]);
                _f = (_e = JSON).parse;
                return [4 /*yield*/, util_1.promisify(fs.readFile)('./json/root.json', 'utf-8')];
            case 4:
                roots = _f.apply(_e, [_g.sent()]);
                S_Trie = logic.state_trie_ins(roots.stateroot);
                return [4 /*yield*/, logic.get_tx_statedata(tx, chain, S_Trie)];
            case 5:
                StateData = _g.sent();
                L_Trie = logic.lock_trie_ins(roots.lockroot);
