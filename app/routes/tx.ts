...
export const post = async (msg:Buffer,chain_info_db:vr.db,root_db:vr.db,trie_db:vr.db,tx_db:vr.db,block_db:vr.db,state_db:vr.db,lock_db:vr.db,output_db:vr.db)=>{
    try{
